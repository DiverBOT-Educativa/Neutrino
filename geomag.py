# For this project we have only modified 'altitude' (line 29) to use meters instead of feet
# Otherwise code is identical to its source, https://github.com/cmweiss/geomag
...
class GeoMag:
    ...
    def GeoMag(self, dlat, dlon, h=0, time=date.today()): # latitude (decimal degrees), longitude (decimal degrees), altitude (meters), date
        ...
        alt = h # <- This was the line modified!
